...
# Deliberately no docker CLI/daemon and no gh. sudo works GitHub-hosted
# style: jobs install their own system deps per-run.
RUN apt-get update && apt-get install -y --no-install-recommends \
        git curl unzip jq ca-certificates sudo \
