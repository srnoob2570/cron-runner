...
- **Containment:** both containers drop all capabilities, forbid privilege escalation, cap memory/PIDs, use tmpfs scratch; no docker daemon, socket, volumes, or ports anywhere.
